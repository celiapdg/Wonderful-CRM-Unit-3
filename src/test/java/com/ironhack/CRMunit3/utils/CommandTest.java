...
//    @BeforeEach
//    void setUp() {
//        testValid = new Lead("Carlos Botijo", "647321593","carlos@email.com", "Transportes Botijo S.L.", salesRep);
//        testInvalid = new Lead("Carlos Boti4jo", "647321593","carlos@email.com", "Transportes Botijo S.L.", salesRep);
//        leadListTest=new HashMap<>();
//
//        contactValidTest = new Contact("Carlos Botijo", "647321593","carlos@email.com", "Transportes Botijo S.L.", accountId);
//        contactInvalidTest = new Contact("Carlos Boti4jo", "647321593","carlos@email.com", "Transportes Botijo S.L.", accountId);
//
//        opportunityValidTest = new Opportunity(Product.BOX, 2, contactValidTest, salesRep, accountId);
//        opportunityInvalidTest = new Opportunity(Product.BOX, 2, contactInvalidTest, salesRep, accountId);
...
//        assertEquals(opportunityValidTest, Command.createOpportunity(Product.BOX, 2, new Contact("Carlos Botijo", "647321593","carlos@email.com", "Transportes Botijo S.L.", accountId), opportunityListTest));
//    }
//
//    @Test
//    void createOpportunity_invalidValues_Opportunity() {
//        assertEquals(opportunityInvalidTest, Command.createOpportunity(Product.BOX, 2, new Contact("Carlos Boti4jo", "647321593","carlos@email.com", "Transportes Botijo S.L.", accountId), opportunityListTest));
//    }
//
//    @Test
//    void createAccount_validValues_Account() {
//        assertEquals(validAccount, Command.createAccount(Industry.ECOMMERCE, 2, "Narnia", "Narnia",
//                new Contact("Carlos Botijo", "647321593","carlos@email.com", "Transportes Botijo S.L.", accountId),
//                new Opportunity(Product.BOX, 2, contactValidTest, salesRep, accountId)));
//    }
//
//    @Test
...
//                new Contact("Carlos Boti4jo", "647321593","carlos@email.com", "Transportes Botijo S.L.", accountId),
//                new Opportunity(Product.BOX, 2, contactInvalidTest, salesRep, accountId)));
//    }
//
//    @Test
...
//        opportunityListTest.put(1, new Opportunity(Product.BOX, 2, new Contact("Carlos Botijo", "647321593","carlos@email.com", "Transportes Botijo S.L.", accountId), salesRep, accountId));
